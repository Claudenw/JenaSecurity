...
public class SecuredAssembler extends ModelAssembler {
	 ...
	 * Registers the prefix "sec" with the uri http://xenei.org/jena/security/Assembler#
	 * and registers this assembler with the uri http://xenei.org/jena/security/Assembler#Model
	 */

...
public abstract class SecuredItemImpl implements SecuredItem
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.xenei.jena.server.security.SecuredItem#canCreate()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.xenei.jena.server.security.SecuredItem#canDelete()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.xenei.jena.server.security.SecuredItem#canRead()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.xenei.jena.server.security.SecuredItem#canUpdate()
	 */
	@Override
	...
	{
		checkRead(t);
		final Node n = uri == null ? new Node(Type.Anonymous, null) : new Node(
				Type.URI, uri);
		checkRead(new Triple(n, SecuredItemImpl.convert(RDF.subject.asNode()),
				t.getSubject()));
		checkRead(new Triple(n,
				SecuredItemImpl.convert(RDF.predicate.asNode()),
				t.getPredicate()));
		checkRead(new Triple(n, SecuredItemImpl.convert(RDF.object.asNode()),
				t.getObject()));
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.xenei.jena.server.security.SecuredItem#equals(java.lang.Object)
	 */
	@Override
	public boolean equals( final Object o )
	{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.xenei.jena.server.security.SecuredItem#getBaseItem()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.xenei.jena.server.security.SecuredItem#getModelIRI()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.xenei.jena.server.security.SecuredItem#getSecurityEvaluator()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.xenei.jena.server.security.isEquivalent()
	 */
	@Override
